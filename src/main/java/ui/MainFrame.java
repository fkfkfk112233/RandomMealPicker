...
public class MainFrame extends JFrame {
    ...
    private static final String[] TYPE_OPTIONS = { "中式", "日式", "速食", "其他" };
    private static final String[] FILTER_OPTIONS = { "全部", "中式", "日式", "速食", "其他" };
    ...
    private void initInputArea() {
        ...
        cbType.setModel(new DefaultComboBoxModel(new String[] {"中式", "日式", "西式", "速食", "其他"}));
